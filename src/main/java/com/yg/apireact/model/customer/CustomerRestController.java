...
public class CustomerRestController {
  ...
  public ResponseEntity<Map<String, Object>> getAllTutorials(
	...
	@CrossOrigin(origins =  {"http://localhost:8082", "http://localhost:3000"}, methods = {RequestMethod.DELETE, RequestMethod.OPTIONS})
    ...
    @CrossOrigin(origins =  {"http://localhost:8082", "http://localhost:3000"}, methods = {RequestMethod.PUT, RequestMethod.OPTIONS})
